 ...
 */
export function parseMonetaryValue(input: string | null | undefined): ParsedMonetaryValue {
    const result: ParsedMonetaryValue = {
        success: false,
        value: null,
 ...
 */
export function parseKilometerValue(input: string | null | undefined): ParsedKilometerValue {
    const result: ParsedKilometerValue = {
        success: false,
        value: null,
        originalString: input || '',
    };
